...
void processReceivedData(uint8_t* data, uint32_t identifier) {
  switch (identifier) {
    ...
    case 0x18904001:
      ...
      send_data("baterySE_soc", bmsData24V.soc); 
      send_data("batterySE_current_a", bmsData24V.current);
      send_data("batterySE_voltage_v", bmsData24V.totalVoltage);
      break;
    ...
    case 0x18924001:
      ...
      send_data("batterySE_maxTemp_c", bmsData24V.maxTemp);
      send_data("batterySE_minTemp_c", bmsData24V.minTemp);
      break;
...
void dedecodeMessage1(const CanFrame &frame) {
    ...
    send_data("motor_voltage_v", controllerData.battery_voltage);
    //send_data("battery_current_a" )
...
void decodeMessage2(const CanFrame &frame) {
    ...
    send_data("motor_switch_signals_status", switch_signals);
    send_data("motor_controller_status", controller_status);
